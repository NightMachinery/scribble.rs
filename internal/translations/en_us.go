...
func initEnglishTranslation() *Translation {
	...
	translation.put("manage-players", "Manage players")
	translation.put("kick-player", "Kick player")
	translation.put("force-player-spectator", "Force spectator")
	...
	translation.put("drawer-forced-spectator", "Since the drawer was moved to spectator mode, none of you will get any points this round.")
	...
	translation.put("owner-kicked-player", "%s was kicked by the lobby owner.")
	translation.put("owner-forced-spectator", "%s was moved to spectator mode by the lobby owner.")
	...
	translation.put("word-pack", "Word Pack")
	...
	translation.put("lobby-password-setting", "Lobby Password")
	translation.put("lobby-password-placeholder", "Enter a password")
	translation.put("lobby-password-set", "Password set")
	translation.put("lobby-password-not-set", "No password set")
	translation.put("remove-lobby-password", "Remove current password")
	...
	translation.put("private-lobby-password-title", "Private lobby password")
	translation.put("private-lobby-password-description", "Enter the lobby password to join this private game.")
	translation.put("join-private-lobby", "Join private lobby")
	...
	translation.put("lobby-password-invalid", "The supplied lobby password is incorrect.")
